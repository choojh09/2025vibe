...
st.set_page_config(page_title="뉴스 큐레이터", layout="wide")
...
with tab1:
    ...
    selected_category = st.selectbox("카테고리를 선택하세요", list(NEWS_CATEGORIES.keys()))
...
with tab2:
    ...
    PRESS_RSS = {
        ...
        "중앙일보": "https://www.joongang.co.kr/rss?cloc=joongang|header|rss",
        ...
        "SBS": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=01",  # 종합
        "KBS": "https://news.kbs.co.kr/rss/rss.xml",
        "한국경제": "https://www.hankyung.com/rss/news.xml"
    }
    selected_press = st.selectbox("언론사를 선택하세요", list(PRESS_RSS.keys()))
